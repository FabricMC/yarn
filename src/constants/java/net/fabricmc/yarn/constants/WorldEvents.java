...
/**
 * Constants of World Event IDs.<p>
 * World Events are used to trigger things on the client from the server side.
 * Most commonly, playing sound events or spawning particles.<p>
 * Some events have an extra data integer sent alongside them.<br>
 * Some events are global, meaning they will be sent to every player regardless of their position.<p>
...
public final class WorldEvents {
	 ...
	 * Plays the dispensing sound event.<p>
	 ...
	 * Plays the dispenser fail sound event.<p>
	 ...
	 * Plays the dispenser launch sound event.<p>
	 ...
	 * Plays the eye of ender launching sound event.<p>
	 ...
	 * Plays the firework shoot sound event.<p>
	 ...
	 * Plays the iron door opening sound event.<p>
	 ...
	 * Plays the wooden door opening sound event.<p>
	 ...
	 * Plays the wooden trapdoor opening sound event.<p>
	 ...
	 * Plays the fence gate opening sound event.<p>
	 ...
	 * Plays the fire extinguish sound event.<p>
	 ...
	 * The Raw ID of the Music Disc item must be supplied as extra data. If {@code 0} is supplied, music will stop.<p>
	 ...
	 * Plays the iron door closing sound event.<p>
	 * Called by {@link net.minecraft.block.DoorBlock#playOpenCloseSound(net.minecraft.world.World, net.minecraft.util.math.BlockPos, boolean) DoorBlock#playOpenCloseSound}
	 */
	 ...
	 * Plays the wooden door closing sound event.<p>
	 * Called by {@link net.minecraft.block.DoorBlock#onUse(net.minecraft.block.BlockState, net.minecraft.world.World, net.minecraft.util.math.BlockPos, net.minecraft.entity.player.PlayerEntity, net.minecraft.util.Hand, net.minecraft.util.hit.BlockHitResult) DoorBlock#onUse}, 
	 * and {@link net.minecraft.block.DoorBlock#playOpenCloseSound(net.minecraft.world.World, net.minecraft.util.math.BlockPos, boolean) DoorBlock#playOpenCloseSound}
	 */
	 ...
	 * Plays the wooden trapdoor closing sound event.<p>
	 * Called by {@link net.minecraft.block.TrapdoorBlock#playToggleSound(net.minecraft.entity.player.PlayerEntity, net.minecraft.world.World, net.minecraft.util.math.BlockPos, boolean) TrapdoorBlock#playToggleSound}
	 */
	 ...
	 * Plays the fence gate closing sound event.<p>
	 * Called by {@link net.minecraft.block.FenceGateBlock#onUse(net.minecraft.block.BlockState, net.minecraft.world.World, net.minecraft.util.math.BlockPos, net.minecraft.entity.player.PlayerEntity, net.minecraft.util.Hand, net.minecraft.util.hit.BlockHitResult) FenceGateBlock#onUse}, 
	 * and {@link net.minecraft.block.FenceGateBlock#neighborUpdate(net.minecraft.block.BlockState, net.minecraft.world.World, net.minecraft.util.math.BlockPos, net.minecraft.block.Block, net.minecraft.util.math.BlockPos, boolean) FenceGateBlock#neighborUpdate}
	 */
	 ...
	 * Plays the ghast warn sound event.<p>
	 ...
	 * Plays the ghast shoot sound event.<p>
	 * Called by {@link net.minecraft.entity.mob.GhastEntity.ShootFireballGoal#tick() GhastEntity.ShootFireballGoal#tick}
	 */
	 ...
	 * Plays the ender dragon shoot sound event.<p>
	 ...
	 * Plays the blaze shoot sound event.<p>
	 ...
	 * Plays the zombie attacking wooden door sound event.<p>
	 ...
	 * Plays the zombie breaking wooden door sound event.<p>
	 * Called by {@link net.minecraft.entity.ai.goal.BreakDoorGoal#tick() BreakDoorGoal#tick}
	 */
	 ...
	 * Plays the wither breaking block sound event.<p>
	 ...
	 * Plays the wither shoot sound event.<p>
	...
	/**
	 * A Bat takes off.<br>
	 * Plays the bat take off sound event.<p>
	 ...
	 * Plays the zombie infect villager sound event.<p>
	 ...
	 * Plays the zombie villager cured sound event.<p>
	 ...
	 * Plays the anvil destroyed sound event.<p>
	...
	/**
	 * An Anvil is used.<br>
	 * Plays the anvil used sound event.<p>
	 ...
	 * Plays the anvil landing sound event.<p>
	 ...
	 * Plays the portal travel sound event directly through the client's sound manager.<p>
	 ...
	 * Plays the chorus flower growing sound event.<p>
	 ...
	 * Plays the chorus flower death sound event.<p>
	 ...
	 * Plays the brewing stand brewing sound event.<p>
	 ...
	 * Plays the iron trapdoor closing sound event.<p>
	 * Called by {@link net.minecraft.block.TrapdoorBlock#playToggleSound(net.minecraft.entity.player.PlayerEntity, net.minecraft.world.World, net.minecraft.util.math.BlockPos, boolean) TrapdoorBlock#playToggleSound}
	 */
	 ...
	 * Plays the iron trapdoor opening sound event.<p>
	 * Called by {@link net.minecraft.block.TrapdoorBlock#playToggleSound(net.minecraft.entity.player.PlayerEntity, net.minecraft.world.World, net.minecraft.util.math.BlockPos, boolean) TrapdoorBlock#playToggleSound}
	 */
	 ...
	 * Plays the phantom bite sound event.<p>
	 ...
	 * Plays the zombie convert to drowned sound event.<p>
	 ...
	 * Plays the husk convert to zombie sound event.<p>
	 ...
	 * Plays the grindstone used sound event.<p>
	 ...
	 * Plays the page turn sound event.<p>
	 ...
	 * Plays the smithing table used sound event.<p>
	 ...
	 * Plays the pointed dripstone landing sound event.<p>
	 ...
	 * Plays the pointed dripstone dripping lava into cauldron sound event.<p>
	 ...
	 * Plays the pointed dripstone dripping water into cauldron sound event.<p>
	 * Called by {@link net.minecraft.block.CauldronBlock#fillFromDripstone(net.minecraft.block.BlockState, net.minecraft.world.World, net.minecraft.util.math.BlockPos, net.minecraft.fluid.Fluid) CauldronBlock#fillFromDripstone}, 
	 ...
	 * Plays the skeleton convert to stray sound event.<p>
	 ...
	 * Plays the appropriate composting sound event and spawns composter particles.<p>
	 * A {@code 1} should be parsed as extra data if the use of the composter added to the level of compost inside.<p>
	 ...
	 * Plays the lava extinguish sound event and spawns large smoke particles.<p>
	 ...
	 * Plays the redstone torch burn out sound event and spawns smoke particles.<p>
	 ...
	 * Plays the end portal frame filled sound event and spawns smoke particles.<p>
	 * Called by {@link net.minecraft.item.EnderEyeItem#useOnBlock(net.minecraft.item.ItemUsageContext) EnderEyeItem#useOnBlock}
	 */
	 ...
	 * Spawns dripping fluid particles.<p>
	 ...
	 * The ordinal direction the dispenser is facing must be supplied as extra data.<p>
	 ...
	 * Plays the appropriate block breaking sound event and spawns block breaking particles.<p>
	 * The raw ID of the block must be supplied as extra data.<p>
	 ...
	 * Plays the splash potion breaking sound event and spawns splash potion particles.<p>
	 * The hex color of the potion must be supplied as extra data.<p>
	 * For instant effects such as Instant Health and Instant Damage, use {@link INSTANT_SPLASH_POTION_SPLASHED}.<p>
	 ...
	 * Spawns smoke and flame particles.<p>
	 ...
	 * Spawns happy villager particles.<p>
	 ...
	 * Plays the dragon fireball explode sound event and spawns dragon breath particles.<p>
	 ...
	 * Plays the splash potion breaking sound event and spawns instant splash potion particles.<p>
	 * The hex color of the potion must be supplied as extra data.<p>
	 * For non-instant effects, use {@link SPLASH_POTION_SPLASHED}.<p>
	 ...
	 * Spawns an explosion particle.<p>
	 ...
	 * Plays the end gateway spawn sound event and spawns an explosion emitter particle.<p>
	 ...
	 * Plays the ender dragon growl sound event.<p>
	 ...
	 * Spawns electric spark particles.<p>
	 * The ordinal direction the lightning rod is facing must be supplied as extra data.<br>
	 * {@code -1} is passed if the event is called by a lightning entity itself.<p>
	...
	/**
	 * A block is waxed.<br>
	 * Plays the block waxing sound event and spawns waxing particles.<p>
	 ...
	 * Spawns wax removal particles.<p>
